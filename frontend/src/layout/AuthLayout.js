...
export class AuthLayout {
  ...
  async setup() {
    ...
    this.container.innerHTML = `
      <div class="w-full md:w-[700px] lg:w-[900px] flex items-center h-full md:h-[90vh] p-2 shadow-lg rounded-xl bg-white">
        <img src="${IMAGES.background}" alt="background" class="h-full object-cover w-1/2 rounded-xl hidden md:block" />
        <div class="relative w-full relative flex flex-col items-center justify-center h-full" id="auth-content"></div>
      </div>
    `;
